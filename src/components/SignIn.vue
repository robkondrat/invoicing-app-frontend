      ...
      <div class="col-md-12">
        <form @submit.prevent="login">
          <div class="form-group">
            ...
            <input type="email" class="form-control" placeholder="eg rob@invoiceapp.com" v-model="model.email">
          </div>
      ...
      <div class="col-md-12">
        <form @submit.prevent="register">
          <div class="form-group">
            ...
            <input type="text" required class="form-control" placeholder="eg Rob" v-model="model.name">
          </div>

          <div class="form-group">
            <label for="">Email:</label>
            <input type="email" required class="form-control" placeholder="eg rob@invoiceapp.com" v-model="model.email">
          </div>

          <div class="form-group">
            <label for="">Company Name</label>
            <input type="text" required class="form-control" placeholder="Rob Inc." v-model="model.company_name">
          </div>
